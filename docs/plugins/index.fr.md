...
Vous pouvez activer de nouveaux plug-ins depuis l'onglet Paramètres de _Sharly Chess_. Les plug-ins actifs peuvent ensuite être activés ou désactivés pour chaque évènement.  
