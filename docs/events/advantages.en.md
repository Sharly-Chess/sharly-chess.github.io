...
permalink: /integration/advantages
page_id: integration-advantages
nav_order: 100
---

# _Sharly-Chess.com_ — Advantages

_Sharly-Chess.com_ offers on online platform for managing tournaments registrations and displaying their results.  If you're wondering why you might want to use _Sharly-Chess.com_, you should read this page...
...
- automatic and reliable retrieval of name, surname, rating, licence, etc.
...
- direct synchronisation with _Sharly Chess_ arbitration software
...
Perfect synchronisation between the arbitration software and the information displayed on _Sharly-Chess.com_:

- pairings and results guaranteed to match those displayed in the playing hall
...
With _Sharly Chess_, you can number all tables consecutively from the start, then simply assign each tournament its starting table number once the number of players is known.
...
- maintain the platform, which relies on a resilient professional infrastructure
- develop new features expected by organisers and arbiters
- provide ongoing support to the _Sharly Chess_ community
...
- for arbiters, who work in better conditions and focus on their core business: arbitration
- for players, who benefit from a smoother experience

If you use _Sharly Chess_ and it brings you value, this platform is today **the best way** to support its continued development.
