...
| **Dossier** | Dossier dans lequel le fichier _[Papi]({% link docs/getting-started/papi-and-sharly-chess.fr.md %})_ sera stocké (optionnel, par défaut le dossier des fichiers _Papi_ de l’événement).
