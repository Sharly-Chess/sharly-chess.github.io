...
| **Nom** | Un nom lisible utilisé à des fins d’affichage (par exemple sur les [Écrans](/screens)). |
...
| **Dossier** | Dossier dans lequel le fichier _[Papi](/relation-to-papi)_ sera stocké (écrase la valeur définie au niveau de l’événement). |
...
Des [plugins](/plugin-support) peuvent ajouter des champs supplémentaires au formulaire de création selon leurs fonctionnalités.
