...
| **Dossier par défaut pour les fichiers _Papi_** | Actuellement, la plupart des données de tournoi sont stockées dans un fichier _[Papi]({% link docs/getting-started/papi-and-sharly-chess.fr.md %})_.
