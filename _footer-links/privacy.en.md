...
This data processing allows Sharly Chess to manage its registered users and is justified by the performance of the contract to which you are a party, namely the Sharly Chess [Terms of Use]({% link _footer-links/terms-and-conditions.en.md %}), in accordance with Article 6.1.b) of the GDPR.
