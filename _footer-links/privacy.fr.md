...
Cette conservation est justifiée par l'intérêt légitime de _Sharly Chess_ à protéger et défendre ses droits et intérêts, y compris en justice, conformément à l'article 6.1.f) du RGPD.
...
Cette conservation est justifiée par le respect d'une obligation légale à laquelle _Sharly Chess_ est soumise, conformément à l'article 6.1.c) du RGPD.
...
|---|---|---|---|
| Informations relatives à votre navigateur Internet et votre terminal (requête HTTP) | Connexion au site sharly-chess.com, détection de bugs et de tentatives de cyberattaques | Intérêt légitime de _Sharly Chess_ (article 6.1.f) du RGPD) | 1 an suivant la collecte des données, puis durée de prescription légalement applicable (en principe 5 ans) |
...
| Données d'identification | Amélioration de l'expérience de navigation des utilisateur·ices inscrit·es (collecte d'informations par des cookies de session) | Intérêt légitime de _Sharly Chess_ (article 6.1.f) du RGPD) | Le temps de la session de navigation, sous réserve de la configuration de ces cookies par l'utilisateur·ice |
| Données d'identification | &nbsp;Support technique | Intérêt légitime de _Sharly Chess_ (article 6.1.f) du RGPD) | Jusqu'à la résolution du problème technique puis durée de prescription légalement applicable (en principe 5 ans) |
| Données d'identification | Amélioration des services | Intérêt légitime de _Sharly Chess_ (article 6.1.f) du RGPD) | Durée nécessaire à l'identification des pistes d'amélioration des services puis durée de prescription légalement applicable (en principe 5 ans, conservation à titre de preuve en vue d'un éventuel litige) |
...
| Données d'identification | Gestion des litiges | Intérêt légitime de _Sharly Chess_ (article 6.1.f) du RGPD)&nbsp; | Durée de prescription légalement applicable (en principe 5 ans) |
| Données d'identification | Respect d'une obligation légale | Obligation légale de _Sharly Chess_ (article 6.1.c) du RGPD) | 1 an, puis durée de prescription légalement applicable selon les obligations légales concernées |
...
Sachez toutefois que _Sharly Chess_ est en droit de s'opposer à la suppression de certaines données, lorsque leur conservation est nécessaire pour des raisons particulièrement importantes, telles que la protection et la défense de ses intérêts en justice.
