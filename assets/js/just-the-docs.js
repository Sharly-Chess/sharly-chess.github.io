...
function initSearch() {
  ...
  // TA: prefix is used to support multiple languages
  {% if site.active_lang == site.default_lang %}
    {% assign prefix = '' %}
  {% else %}
    {% assign prefix = '/' | append: site.active_lang %}
  {% endif %}
  request.open('GET', '{{ prefix | append: "/assets/js/search-data.json" | relative_url }}', true);
